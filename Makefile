...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/04/14 19:05:20 by kchaozu           #+#    #+#              #
#    Updated: 2020/02/10 23:12:05 by kchaozu          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_bzero.c  ft_compare.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
...
ft_putendl.c  ft_putnbr.c  ft_putnbr_fd.c  ft_putstr_fd.c  ft_putstr.c \
ft_strcat.c  ft_strchr.c  ft_strclr.c  ft_strcmp.c  ft_strcpy.c \
ft_strdel.c ft_strdup.c  ft_strequ.c  ft_striter.c  ft_striteri.c \
ft_strjoin.c  ft_strlcat.c  ft_strlen.c  ft_strmap.c  ft_strmapi.c \
ft_strncat.c  ft_strncmp.c  ft_strncpy.c  ft_strnequ.c  ft_strnew.c \
ft_strnstr.c  ft_strrchr.c  ft_strsplit.c  ft_strstr.c  ft_strsub.c \
ft_strtrim.c  ft_tolower.c  ft_toupper.c  ft_gnl.c  ft_quicksort.c  ft_words.c

OBJ =  ft_atoi.o ft_bzero.o  ft_compare.o ft_isalnum.o  ft_isalpha.o  ft_isascii.o \
...
ft_putendl.o  ft_putnbr.o  ft_putnbr_fd.o  ft_putstr_fd.o  ft_putstr.o \
...
ft_strtrim.o  ft_tolower.o  ft_toupper.o  ft_gnl.o ft_quicksort.o  ft_words.o
